...
class ContactoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'apellido' =>'required' ,'correo'=>'required','celular' =>'required','direccion' => 'required' ]);
    ...
    {
        $this->validate($request,[ 'nombre'=>'required', 'apellido'=>'required','correo'=>'required','celular' =>'required','direccion'=>'required']);
